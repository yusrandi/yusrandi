...
export default function AboutMe(props: any) {
  const technologies = [
    ["Flutter", "Laravel", "React Native", "Next.js", "TypeScript"],
    ...
    <div id="aboutSection" data-aos="fade-up" className="snap-start flex flex-col  items-center py-20 bg-AAprimary">
      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Yusrandi, and I am a passionate software engineer and problem solver. My journey in application development commenced during my college years, where I immersed myself in the realm of coding with Java. Starting from desktop applications, I gradually delved into the intricate world of native Android development. Eager to explore more innovative avenues, I then embraced the dynamic landscape of application development by leveraging frameworks like Flutter and Laravel. These experiences not only honed my skills but also instilled in me a profound appreciation for the art of crafting digital solutions.
              </span>
          ...
          <div className="group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden ">
            <div
              className="group-hover:translate-x-3 group-hover:translate-y-3
               duration-300 absolute w-5/6 lg:h-[360px] md:h-[270px] border-2 border-AAsecondary translate-x-5 
          ...
          {/* // ?Image in Mobile */}
          <div className=" relative w-full h-full md:hidden  flex justify-center items-center">
